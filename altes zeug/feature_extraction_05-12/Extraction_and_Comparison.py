...
def loadSavedFeatures(feature_dir):
    ...
    for i in range(numberOfFeatures):
        ...
        img_names.append(os.path.splitext(img_name)[0] + ".jpg")  # save img name at position i
...
def similiarImgPaths(query_vector, feature_dir):
    ...
    similar_img_paths = []
    for i in indexes:
        similar_img_paths.append("./static/images/" + loadSavedFeatures(feature_dir)[1][i])
...
if __name__ == "__main__":
    ...
    #print(similiarImg(query_vector, feature_dir))
